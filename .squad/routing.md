...
|-----------|----------|----------|
| Python/HA implementation | Geordi | New sensors, config flow, entity logic, bug fixes |
| Tests & QA | Worf | Writing tests, validating features, edge cases |
| Code review | Spock | Review PRs, check quality, architecture decisions |
| Architecture & scope | Spock | What to build, trade-offs, HA patterns |
| Issue triage | Spock | Analyze issues, assign squad labels |
